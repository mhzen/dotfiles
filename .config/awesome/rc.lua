...
local mytextclock = wibox.widget.textclock(markup.fg.color("#D9E0EE", '  %R '))
...
local volume = lain.widget.alsa {
  settings = function()
    if volume_now.status == "off" then
      widget:set_markup(markup.fg.color("#6E6C7E", "  " .. volume_now.level .. "%"))
    elseif tonumber(volume_now.level) == 0 then
      widget:set_markup(markup.fg.color("#6E6C7E", "  " .. volume_now.level .. "%"))
    elseif tonumber(volume_now.level) <= 50 then
      widget:set_markup(markup.fg.color("#B5E8E0", "  " .. volume_now.level .. "%"))
    else
...
globalkeys = gears.table.join(
    ...
    awful.key({ modkey, "Control" }, "Tab", function() awful.spawn("rofi -show window") end,
        {description = "run prompt", group = "launcher"}),
    ...
    awful.key({ modkey, }, "r", function() awful.spawn("rofi -show drun") end,
        {description = "show launcher menu", group = "launcher"})
